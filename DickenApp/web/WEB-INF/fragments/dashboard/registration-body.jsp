                    ...
                    <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <form class="row g-3 needs-validation" novalidate id="signup">
                                    <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        <label for="yourEmail" class="form-label">Your Matric Number</label>
                                        <input type="text" id="matNumber" class="form-control" id="yourEmail" required>
                                    ...
                                    <div class="col-12">
                                        <label for="yourUsername" class="form-label">Faculty</label>
                                        <div class="input-group has-validation">
                                            <input type="text" id="faculty" class="form-control" id="yourUsername" required>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="input-group has-validation">
                                            <input type="text" id="departtment" class="form-control"  required>
